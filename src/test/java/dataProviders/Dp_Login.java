...
public class Dp_Login{
	...
	public static Iterator<Object[]> dp_invalidLogin() throws Exception{
		List<Object[]> Loginlist = commondpLogic("Invalid_login");
	...
	public static Iterator<Object[]> dp_validLogin() throws Exception{
		List<Object[]> Loginlist = commondpLogic("Valid_login");
		return Loginlist.iterator();
			
	}
		
	
	public static List<Object[]> commondpLogic(String scriptid) throws Exception{
...
//		row iterations
		for(int iRow =1;iRow<=rowcount ;iRow++){
			...
			if(excelRW.readcellvalue("Login",iRow,2).equals("Y") && excelRW.readcellvalue("Login",iRow,3).equals(scriptid)){
//			map to store data
